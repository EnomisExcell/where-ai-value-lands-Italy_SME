...
## Sustained-ROI evidence for Italian SMEs and enterprise team workflows (added 2026-05-27 via contributor PR)
Questions surfaced by the operator daily thought of 2026-05-26 and the `/discover` pass that followed. Each touches the **temporal-sustainability axis** [[H2_u-curve-of-value]] has not been tested against in the wiki so far.
- [ ] **Transition 5.0 grant outcomes.** For what fraction of Italian SME AI deployments that receive Transition 5.0 or equivalent state-coordinated grant support does the cost/benefit balance turn decidedly positive within five months and hold for at least twelve? The single existing Italian SME case in the wiki ([[sme-optimiser-cross-functional-stack]], Brescia bag manufacturer) is grant-supported but unmeasured longitudinally. If grant-supported deployments cross the J-curve trough at materially higher rates than self-funded ones, the policy lever in [[sme-policy-pathway-novice-to-champion]] is empirically the binding constraint on Italian SME AI adoption, not skills or finance directly.
- [ ] **Measurement gap — cause or effect of the failure rate.** Is the **46% of large Italian GenAI-using firms that do not attempt to measure benefits** (Osservatorio Politecnico di Milano, 2025) a *cause* of the MIT NANDA-class 95% pilot failure rate (deployments fail because they are not instrumented to identify what to keep), or a *consequence* (deployments are not measured because outcomes are visibly disappointing and measurement would crystallise the loss)? The two readings have inverse policy and operator-side implications. Sharpens [[scaling-gap]]'s three-reading ambiguity by adding an operational-root-cause fourth reading.
- [ ] **Function-level replicability of the legal-tech ROI window.** Aggregated practitioner data places simple legal contract-review AI deployments at 1–3 months positive ROI and complex ones at 6 months — the cleanest functional segment above the operator-side five-month threshold. Does this replicate for FP&A / controlling, HR / talent acquisition, customer-success, and shared-services functions inside Italian mid-market enterprises (€10M–€200M revenue), or is the legal segment structurally special because of the document-bounded task structure and the per-hour rate of the labour being substituted? Determines whether function-level positioning generalises beyond legal-tech as a sustained-ROI play.
